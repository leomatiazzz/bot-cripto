...
Ter o Node.js instalado (versão 16+ recomendada).

Criar uma conta na Binance Testnet (https://testnet.binance.vision/).

Gerar chaves de API no site da Binance Testnet para permitir autenticação.

Criar um arquivo .env para armazenar suas chaves API de forma segura.
